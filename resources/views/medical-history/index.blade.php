...
@section('buttons')
    <a href="{{ route('medical-histories.create') }}">
...
@section('script')
    <script>
        $('#dataTable-1').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('medical-histories.all') }}", // URL to fetch data
                type: 'GET',
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        var editUrl = '/medical-histories/' + row.id + "/edit";
                        var deleteUrl = '/medical-histories/' + row.id;
