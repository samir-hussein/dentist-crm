                                            ...
                                            @if ($treatment->treatmentType->need_labs)
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-12 col-md-6">
                                                        ...
                                                        <select multiple
                                                            class="form-control select2-multi lab-work d-block w-100"
                                                    ...
                                                    <div class="form-group col-12 col-md-6">
                                                        <label
                                                            for="simple-select{{ $treatment->treatmentType->id }}">Labs</label>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-12 col-md-6">
                                                        <label>Charges</label>
                                                        <input type="password" class="form-control" min="0"
                                                            id="cost" autocomplete="off"
                                                ...
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input lab-done"
                                                        id="cementation-delivery-{{ $treatment->treatmentType->id }}"
                                                        {{ $data->session->labOrder?->done ? 'checked' : '' }}>
                                                    <label class="custom-control-label"
                                                        for="cementation-delivery-{{ $treatment->treatmentType->id }}">Cementation
                                                        Delivery</label>
                                                </div> <!-- form-group -->
                                            @endif
                                        </div>
